    ...
    def GameStart(self):
        ...
        def start():
            ...
            btn_exit = Button(btn_group, text='返回', width=20, height=2, font=('微软雅黑', 16),
                              bg='#E6A23C', fg='white', activebackground='#FFB900',
                              relief='flat', overrelief='raised', command=lambda: video.destroy())
        ...
        def MainGame(video):
            ...
            def judge(ges):
                ...
                if (scorenum <= 0 ):
                    ...
                    message = Label(fail, text="很遗憾您输掉了比赛\n正在返回准备界面",font=('微软雅黑', 20))
                ...
                if randnum==0:
                    ...
                    g="布"
                if result == 0:
                    info2["text"] = "电脑和您出的都是：" + ges + " 平局"
                    scorenum+=1
                elif result in (1, -2):
                    info2["text"] = "电脑出：" + g + " 您输了"
                    scorenum-=2
                else:
                    info2["text"] = "电脑出：" + g + " 您赢了"
                    scorenum+=2
                score["text"] = "得分：" + str(scorenum)
